...
Чтобы склонировать внешний репозиторий на наш ПК нужно использовать комманду *git clone*. 
Чтобы скачать все из текущего репозитория и автоматически 
сделать merge с нашей версией используем комманду *git pull*.
Чтобы отправить нашу версию репозитория на внешний 
репозиторий используем комманду *git push*. Требует авторизации на внешнем репозитории.
