...
Для того чтобы загрузить ваши изменения в удалённый репозиторий воспользуетесь командой *git push origin master*. Для этого в папке репозитория в терминале необходимо использовать команду *git push origin master*.
